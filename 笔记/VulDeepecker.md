...
- [VulDeePecker](#vuldeepecker)
  - [基本信息](#基本信息)
  - [VulDeepecker设计准则](#vuldeepecker设计准则)
  - [具体设计](#具体设计)
    - [code gadget](#code-gadget)
    - [学习阶段](#学习阶段)
    - [测试阶段](#测试阶段)
  - [未来方向](#未来方向)
  - [相关工作](#相关工作)
- [$\\mu$VulDeePecker](#muvuldeepecker)
  - [Step I](#step-i)
  - [Step II](#step-ii)
  - [Step III](#step-iii)
  - [Step IV](#step-iv)
  ...
  - [多类型统计](#多类型统计)
  - [附录信息](#附录信息)
    - [图像处理的注意力机制](#图像处理的注意力机制)
- [VulDetector](#vuldetector)
  - [Prestep 数据收集](#prestep-数据收集)
  - [STEP I 图提取](#step-i-图提取)
  - [STEP II 关键词、code gadget提取](#step-ii-关键词code-gadget提取)
    - [关键词获取](#关键词获取)
    - [Code Gadget 获取](#code-gadget-获取)
    - [WFG生成](#wfg生成)
    - [图相似算法](#图相似算法)
  - [STEP III 训练](#step-iii-训练)
  - [RESULT](#result)
- [VulDeeLocator](#vuldeelocator)
  - [STEP I sSyVC](#step-i-ssyvc)
  - [STEP I iSeVC](#step-i-isevc)
  - [STEP III Training](#step-iii-training)
- [SySeVR](#sysevr)
  - [STEP I SyVC获取](#step-i-syvc获取)
  - [STEP II SyVCs 转换为 SeVCs](#step-ii-syvcs-转换为-sevcs)
  - [STEP III embedding](#step-iii-embedding)
...
- [DeepWukong](#deepwukong)
  ...
  - [节点嵌入](#节点嵌入)
  - [训练](#训练)
  - [datase and result](#datase-and-result)
    - [dataset](#dataset)
    - [result](#result-1)
- [AutoVAS](#autovas)
